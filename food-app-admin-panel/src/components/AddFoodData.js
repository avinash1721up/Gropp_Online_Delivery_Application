...
const AddFoodData = () => {
    ...
    const [restrauntAddressPincode , setRestrauntAddressPincode] = useState('')

    //console.log(foodName , restaurantName)
           ...
           <div className='form-row'>
            <div className='form-col'>
                ...
                <div className='form-col'>
                    ...
                    <option value="stater">Staters</option>
