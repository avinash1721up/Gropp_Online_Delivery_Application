    ...
    const handleSignup =() =>{
       ...
       try{
            ...
            .catch((error)=>{
                ...
                if(error.message == 'Firebase : The email address is already in use by another account. (auth/email-alreaady-in-use).'){
                    setCustomError('Email already exixts')
                }
                else{
...
{/*password start*/}
          ...
          <View style ={styles.inputout}>
            <AntDesign name="lock" size={24} color={passwordfocus === 
                true ? colors.text1 : colors.text2} />
            ...
            <View style ={styles.inputout}>
            <AntDesign name="lock" size={24} color={cpasswordfocus === 
                true ? colors.text1 : colors.text2} />
